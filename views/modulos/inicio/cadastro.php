            ...
            <form class="needs-validation formulario-ajax" data-form="save" action="<?= SERVERURL ?>ajax/usuarioAjax.php" method="post">
                ...
                <div class="row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" id="nome" name="nome" class="form-control" onkeyup="this.value = this.value.toUpperCase();" required>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="email" class="form-control" name="email2" placeholder="Email" required id="email">
                        <div class="invalid-feedback">
                            <strong>Email já cadastrado</strong>
                        </div>
                    </div>
